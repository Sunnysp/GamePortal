  ...
  g.prototype = {
    ...
    setOptions: function (a) {
      ...
      (a = this.el.offset(), e(this.suggestionsContainer).css({
        top: a.top + this.el.outerHeight()+10 + "px",
        left: a.left - 48 + "px"
      }))
    ...
    suggest: function () {
      if (0 === this.suggestions.length) this.hide(); else {
        ...
        e.each(this.suggestions, function (d, e) {
          g += '<div class="' + c + '" data-index="' + d + '"><img src="../Assets/Images/414340_screenshots_20170807235634_1.jpg" class="sugession-image" />' + a(e, b) + "</div>"
        });
        f.html(g).show();
        this.visible = !0;
